    ...
    <div class="root">
        ...
        <div class="content">
            ...
            <div class="text-container"> 
                ...
                <h3>We understand how valuable your time is, and we want to ensure your baked goods reach you when it's most convenient. With the NRBI zero emission cycling delivery system, you can expect your orders to be delivered between 12:00 pm and 4:00 pm.</h3>
                <h3>Our carefully chosen delivery window aligns with the busiest hours of the day, ensuring that your treats arrive when you're most likely to be home or at the office. This optimized delivery schedule allows us to make the most efficient use of our delivery routes and further reduces our environmental impact.</h3>
                <div class="center-heading">
                ...
                <h3>We are excited to embark on this journey towards a greener future with NRBI by our side. By choosing our zero emission cycling delivery option, you become an integral part of our sustainability mission. Together, we can pedal towards a brighter, cleaner, and more sustainable world.</h3>
                <h3>The next time you place an order with [Your Bakery Name], opt for the NRBI zero emission cycling delivery and take a delicious step towards preserving our planet. Thank you for supporting us in our commitment to making the world a better place—one scrumptious delivery at a time</h3>
