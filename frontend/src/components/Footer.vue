...
<template>
    <div id="footer">
        ...
        <div id="col_3" style="display: flex;">
            <a id="insta-handle" href="https://www.instagram.com/isshobakery/" target="_blank" style="display: inline-block; align-self: flex-end; margin-bottom: 2rem"> 
                <svg id="ig" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000">
